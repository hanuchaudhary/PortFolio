  ...
  return (
    <div className="flex items-center gap-3">
      <a target="_blank" href="https://www.instagram.com/kush.chaudhary.1/"  className="insta hover:scale-125 transition-transform">
        <svg
            className="dark:hover:fill-yellow-500 hover:fill-yellow-600 fill-neutral-950 dark:fill-white fill-neutral-950 dark:fill-white transition-colors"
          fill="#fff"
          height={30}
          width={30}
          role="img"
      ...
      <a target="_blank" href="https://x.com/KushChaudharyOg" className="x hover:scale-125 transition-transform">
        <svg
            className="dark:hover:fill-yellow-500 hover:fill-yellow-600 fill-neutral-950 dark:fill-white transition-colors"
          fill="#fff"
          height={30}
          width={30}
          role="img"
